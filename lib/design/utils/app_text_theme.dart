...
class TextThemeX {
  ...
  static final text32 = TextStyle(
    fontSize: 32,
    fontWeight: FontWeight.w500,
    fontFamily: getPoppinsFontFamily,
  );

  static final text36 = TextStyle(
    fontSize: 36,
    fontWeight: FontWeight.w500,
    fontFamily: getPoppinsFontFamily,
  );

  static final text56 = TextStyle(
    fontSize: 56,
    fontWeight: FontWeight.w500,
    fontFamily: getPoppinsFontFamily,
  );

  static final text64 = TextStyle(
    fontSize: 64,
    fontWeight: FontWeight.w500,
    fontFamily: getPoppinsFontFamily,
  );
